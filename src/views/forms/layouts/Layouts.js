            ...
            <Grid item xs={12} lg={6}>
                <MainCard title="Simple Form Layout">
                    <Grid container spacing={2} alignItems="center">
                        <Grid item xs={12}>
                           <Grid item sm={2}><InputLabel>Name</InputLabel></Grid> 
                            <Grid item sm={9}> <TextField fullWidth placeholder="Enter full name" />
                            <FormHelperText>Please enter your full name</FormHelperText></Grid>
                        </Grid>
                        <Grid item xs={12}>
